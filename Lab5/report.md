...
![подготовка к работе](1.png){ #fig:001 width=70% height=70%}
...
![программа simpleid](2.png){ #fig:002 width=70% height=70%}
...
![результат программы simpleid](3.png){ #fig:003 width=70% height=70%}

6. Усложнили программу, добавив вывод действительных идентификаторов.

![программа simpleid2](4.png){ #fig:004 width=70% height=70%}
...
![результат программы simpleid2](5.png){ #fig:005 width=70% height=70%}

13.	Написали программу readfile.c

![программа readfile](6.png){ #fig:006 width=70% height=70%}
...
![результат программы readfile](7.png){ #fig:007 width=70% height=70%}
...
![исследование Sticky-бита](8.png){ #fig:008 width=70% height=70%}
