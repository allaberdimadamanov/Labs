...
![Добавление пользователей в группу](1.png){ #fig:001 width=70% height=70% }
...
![Содержимое файла /etc/group и регистрация в группе](3.png){ #fig:003 width=70% height=70% }
...
![Изменение прав у директории](5.png){ #fig:004 width=70% height=70% }
...
![Заполнение таблицы](5.png){ #fig:005 width=70% height=70% height=70% }
