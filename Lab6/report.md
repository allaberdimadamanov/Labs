...
![запуск http](1.png){ #fig:001 width=70% height=70%}
...
![переключатели SELinux для http](2.png){ #fig:002 width=70% height=70%}
...
![создание html-файла и доступ по http](4.png){ #fig:003 width=70% height=70%}
...
![ошибка доступа после изменения контекста](5.png){ #fig:004 width=70% height=70%}
...
![доступ по http на 81 порт](6.png){ #fig:006 width=70% height=70%}
